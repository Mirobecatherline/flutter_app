...
class SendPackagePageBackup extends StatefulWidget {
  const SendPackagePageBackup({Key? key}) : super(key: key);

  @override
  State<SendPackagePageBackup> createState() => _SendPackagePageBackupState();
}


class _SendPackagePageBackupState extends State<SendPackagePageBackup> {
...
void main() {
  runApp(const MaterialApp(home: SendPackagePageBackup()));
}